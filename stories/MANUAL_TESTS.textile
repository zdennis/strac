...
Story: As a User I want to be able to see auto-completed tags as I type when creating a story.
  Scenario: picking an existing tag
    Given there is a project
    And a user at that project's workspace page
    When they create a story with the tag "foo"
    And they start creating another story
    And they start typing "f" in the tag field
    Then they will see a dropdown list showing them autocomplete matches to choose from

Story:  As a User I want to be able to create and edit stories|, 
  Scenario: reordering stories
    Given there is a project
    And a user at that project's workspace page
    When they create a story
    Then they will see a message telling them the have created the story
    When they edit that story
    Then they will see message telling them they have updated the story
